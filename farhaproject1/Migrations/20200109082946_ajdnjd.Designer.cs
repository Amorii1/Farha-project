...
namespace farhaproject1.Migrations
{
    ...
    [Migration("20200109082946_ajdnjd")]
    partial class ajdnjd
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("farhaproject1.Models.AddPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("farhaproject1.Models.CutomerSelect", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("DanceTeamId");
                    ...
                    b.HasIndex("DanceTeamId");

                    b.HasIndex("DecorationId");

                    b.HasIndex("HallId");

                    b.ToTable("CutomerSelect");
                });

            modelBuilder.Entity("farhaproject1.Models.DanceTeam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("farhaproject1.Models.PhotoOfDecoration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("farhaproject1.Models.TReservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("farhaproject1.Models.CutomerSelect", b =>
                {
                    b.HasOne("farhaproject1.Models.DanceTeam", "DanceTeam")
                        .WithMany()
                        .HasForeignKey("DanceTeamId")
                        .OnDelete(DeleteBehavior.Cascade);
